...
MODELS: list[RegistryEntry] = [
    ("ipl_from_2023/first_innings/win_prob_v13", "ipl_from_2023", FirstInningsWinProbPipeline),
    ("ipl_from_2023/second_innings/win_prob_v13", "ipl_from_2023", SecondInningsWinProbPipeline),
]
